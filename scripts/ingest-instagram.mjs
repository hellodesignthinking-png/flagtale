...
const TAGS = {
  ...
  익선동: "익선동", 한남동: "한남동", 가로수길: "가로수길", 경리단길: "경리단길", 서촌: "서촌",
  "북촌 한옥마을": "북촌한옥마을", 해방촌: "해방촌", "전주 한옥마을": "전주한옥마을", "경주 황리단길": "경주여행",
  송리단길: "송리단길", 성북동: "성북동", "부산 감천문화마을": "감천문화마을", "제주 월정리": "월정리",
  여수: "여수밤바다", "대전 소제동": "소제동", "부산 전포": "전포카페거리", "광주 동명동": "동명동",
};

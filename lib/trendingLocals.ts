...
export const TRENDING_LOCALS: TrendingLocal[] = [
  { name: "성수동", region: "서울 성동구", cat: "gentri", blurb: "수제화거리에서 카페·쇼룸·브랜드 팝업의 성지로. 크리에이티브 기업이 몰리는 서울 대표 상승 상권.", tags: ["팝업스토어", "카페", "쇼룸"], query: "성수동 팝업 상권", apiQuery: "성수동" },
  { name: "연남동", region: "서울 마포구", cat: "gentri", blurb: "‘연트럴파크’ 경의선숲길을 따라 골목 카페·소품숍·다이닝이 빼곡. 홍대 상권의 확장.", tags: ["경의선숲길", "골목상권", "카페"], query: "연남동 연트럴파크", apiQuery: "연남동" },
  { name: "연희동", region: "서울 서대문구", cat: "gentri", blurb: "조용한 주택가가 베이커리·와인바·다이닝 거리로. 한적함과 미식이 공존하는 동네.", tags: ["베이커리", "다이닝", "주택가"], query: "연희동 맛집 베이커리", apiQuery: "연희동" },
  { name: "문래동", region: "서울 영등포구", cat: "art", blurb: "철공소 골목에 예술가 작업실이 들어선 문래창작촌. 산업유산 + 예술 + 로컬 바.", tags: ["문래창작촌", "철공소", "작업실"], query: "문래동 창작촌 예술", apiQuery: "문래동" },
  { name: "을지로", region: "서울 중구", cat: "gentri", blurb: "‘힙지로’—노포·인쇄골목 사이로 숨은 바·카페. 레트로와 로컬의 재발견.", tags: ["힙지로", "노포", "숨은바"], query: "을지로 힙지로", apiQuery: "을지로" },
  ...
  { name: "목포 청년마을", region: "전남 목포", cat: "creator", blurb: "‘괜찮아마을’ 등 청년마을이 원도심 빈집을 살린 로컬 실험. 한 달 살기·창업으로 화제.", tags: ["청년마을", "괜찮아마을", "한달살기"], query: "목포 청년마을 괜찮아마을", apiQuery: "목포 청년마을" },

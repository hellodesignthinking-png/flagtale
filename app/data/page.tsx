  ...
  return (
    <PageShell>
      ...
      <div className="mb-6 grid grid-cols-2 gap-3 sm:grid-cols-4">
        <Stat label="실연동 소스" value={realCount} accent="blue" sub="경계·인구·상권·빈집·건축·문화·발전가능성" />
      ...
      <Panel className="mt-5">
        ...
        <p className="mt-3 text-[12px] text-muted2">
          ⚠ 현재 <b className="text-muted">KLAI 점수·신호·조달</b>은 예시(합성)입니다. 경계·인구·상권·빈집·건축물·문화·발전가능성은 <b className="text-ink">실데이터</b>. 위 절차로 나머지도 소스별 실데이터로 대체됩니다.
        </p>
      </Panel>
    </PageShell>
  );

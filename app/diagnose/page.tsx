...
export const metadata: Metadata = { title: "유료 지번 진단 — 방향·위기·전략" };
...
export default function DiagnosePage({ searchParams }: { searchParams: { admCd?: string } }) {
  ...
  return (
    <PageShell width="wide">
      <div className="mb-6">
        <span className="klai-eyebrow">Paid Diagnosis</span>
        <h1 className="mt-1 text-3xl font-black">지번 진단 리포트</h1>
